 ...
 */
#ifndef RTW_HEADER_MeasurementF_sf_private_h_
#define RTW_HEADER_MeasurementF_sf_private_h_
#include "rtwtypes.h"
 ...
 *
 */
#if !defined(RTW_GENERATED_SFCN_TUNABLE_PRMS_MeasurementF_sf)
#define J(S)                           _ssGetSFcnParam(S,0)
#define Lm(S)                          _ssGetSFcnParam(S,1)
#define np(S)                          _ssGetSFcnParam(S,2)
#endif                                 /* RTW_GENERATED_SFCN_TUNABLE_PRMS_MeasurementF_sf */
#endif                                 /* RTW_HEADER_MeasurementF_sf_private_h_ */
