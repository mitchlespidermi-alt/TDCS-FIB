...
MODEL              = MeasurementF
MODULES            = MeasurementF_sf_data.c rtGetInf.c rtGetNaN.c 
MAKEFILE           = MeasurementF.mk
...
MEM_ALLOC          = RT_STATIC
MEXEXT             = mexw64
BUILDARGS          =  MODELLIB=MeasurementFlib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE
CREATEMODEL        = 1
USERMODULES        =  
USEPARAMVALUES     = 0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\MeasurementF_sfcn_rtw
