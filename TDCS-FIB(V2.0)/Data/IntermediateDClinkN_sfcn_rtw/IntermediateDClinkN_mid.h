...
/* Instance data for model: IntermediateDClinkN */
void *IntermediateDClinkN_malloc(SimStruct *rts)
{
  ...
  /* block I/O */
  {
    void *b = malloc(sizeof(B_IntermediateDClinkN_T));
