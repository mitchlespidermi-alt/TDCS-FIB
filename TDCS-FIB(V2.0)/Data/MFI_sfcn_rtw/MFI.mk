...
MODEL              = MFI
MODULES            = MFI_sf_data.c rtGetInf.c rtGetNaN.c 
MAKEFILE           = MFI.mk
...
MEM_ALLOC          = RT_STATIC
MEXEXT             = mexw64
BUILDARGS          =  MODELLIB=MFIlib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE
CREATEMODEL        = 1
USERMODULES        =  
USEPARAMVALUES     = 0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\MFI_sfcn_rtw
