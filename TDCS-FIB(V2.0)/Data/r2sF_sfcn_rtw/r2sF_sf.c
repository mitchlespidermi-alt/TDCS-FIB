...
#include <math.h>
#include "r2sF_sf.h"
#include "r2sF_sf_private.h"
#include "simstruc.h"
#include "fixedpoint.h"
#if defined(RT_MALLOC) || defined(MATLAB_MEX_FILE)

extern void *r2sF_malloc(SimStruct *S);
...
{
  B_r2sF_T *_rtB;
  _rtB = ((B_r2sF_T *) ssGetLocalBlockIO(S));

  /* Fcn: '<S1>/Fcn1' incorporates:
   *  Inport: '<Root>/Ub'
   *  Inport: '<Root>/Uc'
   */
  _rtB->Fcn1 = (*((const real_T **)ssGetInputPortSignalPtrs(S, 1))[0] - *((const
    real_T **)ssGetInputPortSignalPtrs(S, 2))[0]) * 0.70710678118654746;
   ...
   *  Inport: '<Root>/Uc'
   */
  _rtB->Fcn = ((*((const real_T **)ssGetInputPortSignalPtrs(S, 0))[0] - *((const
    real_T **)ssGetInputPortSignalPtrs(S, 1))[0] / 2.0) - *((const real_T **)
    ssGetInputPortSignalPtrs(S, 2))[0] / 2.0) * 0.816496580927726;
