 ...
 */
#ifndef RTW_HEADER_InverterTwF_sf_h_
#define RTW_HEADER_InverterTwF_sf_h_
#include <string.h>
#include <stddef.h>
#ifndef InverterTwF_sf_COMMON_INCLUDES_
# define InverterTwF_sf_COMMON_INCLUDES_
#include <stdlib.h>
#define S_FUNCTION_NAME                InverterTwF_sf
...
#endif
#endif                                 /* InverterTwF_sf_COMMON_INCLUDES_ */

#include "InverterTwF_sf_types.h"
 ...
 *
 * hilite_system('CRH2forBenchmark_Copy/InverterF/InverterTwF')    - opens subsystem CRH2forBenchmark_Copy/InverterF/InverterTwF
 * hilite_system('CRH2forBenchmark_Copy/InverterF/InverterTwF/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'CRH2forBenchmark_Copy/InverterF'
 * '<S1>'   : 'CRH2forBenchmark_Copy/InverterF/InverterTwF'
 * '<S2>'   : 'CRH2forBenchmark_Copy/InverterF/InverterTwF/SW'
 */
#endif                                 /* RTW_HEADER_InverterTwF_sf_h_ */
