...
extern void *DCU2_malloc(SimStruct *S);
...
static real_T DCU2_rt_hypotd_snf(real_T u0, real_T u1);
static real_T DCU2_rt_atan2d_snf(real_T u0, real_T u1);
static real_T DCU2_rt_roundd_snf(real_T u);
static real_T DCU2_rt_remd_snf(real_T u0, real_T u1);
...
real_T DCU2_look1_binlxpw(real_T u0, const real_T bp0[], const real_T table[],
  uint32_T maxIndex)
{
  real_T frac;
  uint32_T iRght;
...
static real_T DCU2_rt_remd_snf(real_T u0, real_T u1)
{
  ...
  if (!(y_0 && y_1)) {
    ...
    if ((u1 != 0.0) && (u1 != u)) {
      u = u0 / u1;
      if (fabs(u - DCU2_rt_roundd_snf(u)) <= DBL_EPSILON * fabs(u)) {
        y = 0.0;
      } else {
        y = fmod(u0, u1);
      }
...
#  endif
  ...
  {
    B_DCU2_T *_rtB;
    _rtB = ((B_DCU2_T *) ssGetLocalBlockIO(S));
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  if (ssIsContinuousTask(S, tid)) {
    ...
    if (_rtB->Compare) {
       ...
       */
      _rtB->Compare_h = (_rtB->Sum <= (-5.0));

      /* Gain: '<S68>/Gain1' */
      _rtB->Gain1_p = _rtB->Compare_h ? (real_T)((uint8_T)128U) * 0.015625 : 0.0;
      ...
      /* Gain: '<S68>/Gain' */
      _rtB->Gain_j = _rtB->Compare_b ? (real_T)((uint8_T)128U) * 0.0078125 : 0.0;

      /* Sum: '<S68>/Add' */
      _rtB->Add_m = _rtB->Gain_j + _rtB->Gain1_p;

      /* Sum: '<S68>/Add1' incorporates:
       *  Constant: '<S68>/Constant1'
       */
      _rtB->Add1_f = 1.0 + _rtB->Add_m;
      _rtB->Switch = _rtB->Add1_f;
    } else {
      _rtB->Switch = 1.0;
    }
     ...
     */
    _rtB->Compare_g = (_rtB->Sum > 1.0);

    /* Logic: '<S70>/Logical Operator2' */
    _rtB->LogicalOperator2 = (_rtB->Compare_o && _rtB->Compare_g);

    /* Gain: '<S70>/Gain' */
    _rtB->Gain_h = _rtB->LogicalOperator2 ? (real_T)((uint8_T)128U) * 0.0078125 :
      0.0;

    /* RelationalOperator: '<S78>/Compare' incorporates:
     *  Constant: '<S78>/Constant'
     */
    _rtB->Compare_a = (_rtB->Sum <= 1.0);

    /* RelationalOperator: '<S79>/Compare' incorporates:
     *  Constant: '<S79>/Constant'
     */
    _rtB->Compare_c = (_rtB->Sum > 0.0);

    /* Logic: '<S70>/Logical Operator3' */
    _rtB->LogicalOperator3 = (_rtB->Compare_a && _rtB->Compare_c);
     ...
     */
    _rtB->Compare_o4 = (_rtB->Sum <= 0.0);

    /* RelationalOperator: '<S83>/Compare' incorporates:
     *  Constant: '<S83>/Constant'
     */
    _rtB->Compare_e = (_rtB->Sum > (-2.0));

    /* Logic: '<S70>/Logical Operator1' */
    _rtB->LogicalOperator1 = (_rtB->Compare_o4 && _rtB->Compare_e);
     ...
     */
    _rtB->Compare_j = (_rtB->Sum > (-5.0));

    /* Logic: '<S70>/Logical Operator' */
    _rtB->LogicalOperator = (_rtB->Compare_p && _rtB->Compare_j);
    ...
    /* Sum: '<S70>/Add' */
    _rtB->Add = ((_rtB->Gain_h + _rtB->Gain1) + _rtB->Gain3) + _rtB->Gain2;
  ...
  if (ssIsSampleHit(S, 1, tid)) {
     ...
     */
    _rtB->Add1_j = (*(real_T *)(mxGetData(Vge(S)))) - 5.0;

    /* Product: '<S84>/Divide 1' incorporates:
     *  Constant: '<S84>/Constant3'
     */
    _rtB->Divide1 = 1.625E+7 / _rtB->Add1_j;

    /* Product: '<S84>/Product2' incorporates:
     *  Constant: '<S84>/Constant2'
     */
    _rtB->Product2 = _rtB->Add1_j * 360.0;

    /* Sum: '<S84>/Add' incorporates:
     *  Constant: '<S84>/Constant1'
     */
    _rtB->Add_e = 176000.0 - _rtB->Product2;

    /* Switch: '<S84>/Switch' */
    if (_rtB->Add1_j > 125.0) {
      _rtB->Switch_k = _rtB->Divide1;
    } else {
      _rtB->Switch_k = _rtB->Add_e;
    }
     ...
     *  Constant: '<S84>/d'
     */
    _rtB->Product1 = _rtB->Switch_k * 0.82;

    /* Product: '<S84>/Divide' */
    _rtB->Divide = _rtB->Product1 / DCU2_rtC(S)->Product;
    ...
    if (_rtB->Add2 > 70.0) {
       ...
       *  Constant: '<S75>/Constant8'
       */
      _rtB->Add_n4 = 70.0 - (*(real_T *)(mxGetData(Vge(S))));

      /* Product: '<S75>/Divide1' incorporates:
       *  Constant: '<S75>/Constant2'
       */
      _rtB->Divide1_k = 1.0 / 2.0 * _rtB->Add_n4;

      /* Sum: '<S75>/Add1' incorporates:
       *  Constant: '<S75>/Constant4'
       */
      _rtB->Add1_ae = _rtB->Divide1_k + 172.0;

      /* Product: '<S75>/Divide2' incorporates:
       *  Constant: '<S75>/Constant5'
       */
      _rtB->Divide2 = 1000.0 * _rtB->Add1_ae;
      _rtB->Switch_j = _rtB->Divide2;
    } else {
      _rtB->Switch_j = 172000.0;
    }
     ...
     *  Constant: '<S75>/d'
     */
    _rtB->Product1_i = _rtB->Switch_j * 0.82;

    /* Product: '<S75>/Divide' */
    _rtB->Divide_i = _rtB->Product1_i / DCU2_rtC(S)->Product_g;

    /* Product: '<S75>/Product2' incorporates:
     *  Constant: '<S75>/Constant7'
     */
    _rtB->Product2_l = _rtB->Divide_i * (-1.0);
  }
  ...
  if (ssIsContinuousTask(S, tid)) {
    ...
    if (_rtB->Compare_f) {
      ...
      switch ((int32_T)_rtB->Add1) {
       ...
       case 2:
         ...
         */
        _rtB->Add2_j = _rtB->Sum - 1.0;

        /* Sum: '<S74>/Add 1' incorporates:
         *  Inport: '<Root>/Inport6'
         */
        _rtB->Add1_i = _rtB->Divide - *((const real_T **)
          ssGetInputPortSignalPtrs(S, 6))[0];

        /* Product: '<S74>/Divide1' incorporates:
         *  Constant: '<S74>/Constant1'
         */
        _rtB->Divide1_o = _rtB->Add1_i * _rtB->Add2_j / 4.0;

        /* Sum: '<S74>/Add3' incorporates:
         *  Inport: '<Root>/Inport6'
         */
        _rtB->Add3_h = *((const real_T **)ssGetInputPortSignalPtrs(S, 6))[0] +
          _rtB->Divide1_o;
        _rtB->MultiportSwitch_k = _rtB->Add3_h;
        break;
       ...
       case 3:
         ...
         *  Inport: '<Root>/Inport6'
         */
        _rtB->Product_c = _rtB->Sum * *((const real_T **)
          ssGetInputPortSignalPtrs(S, 6))[0];
        _rtB->MultiportSwitch_k = _rtB->Product_c;
        break;

       case 4:
        _rtB->MultiportSwitch_k = 0.0;
        break;
       ...
       default:
         ...
         */
        _rtB->Add1_m = _rtB->Sum + 2.0;

        /* Product: '<S69>/Divide2' incorporates:
         *  Constant: '<S69>/Constant1'
         */
        _rtB->Divide2_e = _rtB->Product2_l * _rtB->Add1_m / 3.0;
        _rtB->MultiportSwitch_k = _rtB->Divide2_e;
        break;
      }

      /* End of MultiPortSwitch: '<S68>/Multiport Switch' */
      _rtB->Switch_jk = _rtB->MultiportSwitch_k;
    }
    ...
    if (_rtB->Saturation > 125.0) {
       ...
       */
      _rtB->Divide1_l = 1.625E+7 / _rtB->Saturation;
      _rtB->Switch_o = _rtB->Divide1_l;
    } else {
      /* Product: '<S67>/Product2' incorporates:
       *  Constant: '<S67>/Constant2'
       */
      _rtB->Product2_i = _rtB->Saturation * 360.0;

      /* Sum: '<S67>/Add' incorporates:
       *  Constant: '<S67>/Constant1'
       */
      _rtB->Add_a = 176000.0 - _rtB->Product2_i;
      _rtB->Switch_o = _rtB->Add_a;
    }
     ...
     *  Constant: '<S67>/d'
     */
    _rtB->Product1_f = _rtB->Switch_o * 0.82;

    /* Product: '<S67>/Divide ' */
    _rtB->Divide_p = _rtB->Product1_f / DCU2_rtC(S)->Product_n;
    ...
    switch ((int32_T)_rtB->MultiportSwitch1) {
     ...
     case 2:
      _rtB->MultiportSwitch = _rtB->Switch_jk;
      break;

     case 3:
      _rtB->MultiportSwitch = _rtB->Divide_p;
      break;
     ...
     default:
      ...
      if (_rtB->Gain > 70.0) {
         ...
         */
        _rtB->Add_ee = 70.0 - _rtB->Gain;

        /* Product: '<S62>/Divide1' incorporates:
         *  Constant: '<S62>/Constant2'
         */
        _rtB->Divide1_j = 1.0 / 2.0 * _rtB->Add_ee;

        /* Sum: '<S62>/Add1' incorporates:
         *  Constant: '<S62>/Constant4'
         */
        _rtB->Add1_br = _rtB->Divide1_j + 172.0;

        /* Product: '<S62>/Divide2' incorporates:
         *  Constant: '<S62>/Constant5'
         */
        _rtB->Divide2_h = 1000.0 * _rtB->Add1_br;
        _rtB->Switch_h = _rtB->Divide2_h;
      } else {
        _rtB->Switch_h = 172000.0;
      }
       ...
       *  Constant: '<S62>/d'
       */
      _rtB->Product1_g = _rtB->Switch_h * 0.82;

      /* Product: '<S62>/Divide' */
      _rtB->Divide_m = _rtB->Product1_g / DCU2_rtC(S)->Product_c;

      /* Product: '<S62>/Divide3' incorporates:
       *  Constant: '<S62>/Constant6'
       */
      _rtB->Divide3 = _rtB->Divide_m * (-1.0);
  ...
  if (ssIsContinuousTask(S, tid)) {
     ...
     */
    _rtB->Compare_on = (_rtB->MultiportSwitch1 > 3.0);
    ...
    if (_rtB->Compare_on) {
      /* Switch: '<S9>/Switch' */
      if (_rtB->Saturation_a > 200.0) {
        /* Fcn: '<S9>/Fcn' */
        _rtB->Fcn_n = 371.52 / _rtB->Saturation_a;
        _rtB->Switch_ov = _rtB->Fcn_n;
      } else {
        _rtB->Switch_ov = _rtB->perpetual;
      }

      /* End of Switch: '<S9>/Switch' */
      _rtB->Switch1 = _rtB->Switch_ov;
    } else {
      if (_rtB->Saturation_a > 175.0) {
        /* Fcn: '<S9>/Fcn1' incorporates:
         *  Switch: '<S9>/Switch2'
         */
        _rtB->Fcn1_l = 325.08 / _rtB->Saturation_a;

        /* Switch: '<S9>/Switch2' */
        _rtB->Switch2 = _rtB->Fcn1_l;
      } else {
        /* Switch: '<S9>/Switch2' */
     ...
     *  Inport: '<Root>/Inport8'
     */
    _rtB->Gain_g = 2.0 * *((const real_T **)ssGetInputPortSignalPtrs(S, 8))[0];

    /* Sum: '<S7>/Sum1' */
    _rtB->Sum1 = _rtB->Fcn2 + _rtB->Gain_g;

    /* Fcn: '<S13>/Fcn1' */
    _rtB->Fcn1_i = _rtB->Sum1 * _rtB->Fcn1 * 0.0342654 + 0.114 * _rtB->Fcn;
  ...
  if (ssIsContinuousTask(S, tid)) {
    ...
    /* Sum: '<S14>/Add' */
    _rtB->Add_n = _rtB->Product + _rtB->Product3;

    /* Sum: '<S16>/Sum' */
    _rtB->Sum_i = _rtB->Fcn1 - _rtB->Add_n;
  }

  if (ssIsSampleHit(S, 1, tid)) {
    /* Gain: '<S18>/Proportional Gain' */
    _rtB->ProportionalGain = (*(real_T *)(mxGetData(KPM(S)))) * _rtB->Sum_i;

    /* Gain: '<S18>/Integral Gain' */
    _rtB->IntegralGain = (*(real_T *)(mxGetData(KIM(S)))) * _rtB->Sum_i;
    ...
    /* Sum: '<S18>/Sum' */
    _rtB->Sum_l = _rtB->ProportionalGain + _rtB->Integrator;
  }

  if (ssIsContinuousTask(S, tid)) {
    /* Sum: '<S2>/Sum1' */
    _rtB->Sum1_o = _rtB->Fcn1_i + _rtB->Sum_l;
  }
  ...
  if (ssIsContinuousTask(S, tid)) {
    /* Product: '<S4>/Product' */
    _rtB->Product_g = _rtB->Sum1_o * _rtB->TrigonometricFunction_i;

    /* Fcn: '<S13>/Fcn' */
    _rtB->Fcn_h = 0.114 * _rtB->Fcn1 - _rtB->Sum1 * 0.0342654 * _rtB->Fcn *
    ...
    _rtB->Product1_l = _rtB->TrigonometricFunction1 * _rtB->C1;

    /* Sum: '<S14>/Add1' */
    _rtB->Add1_a = _rtB->Product2_e - _rtB->Product1_l;

    /* Sum: '<S17>/Sum' */
    _rtB->Sum_lv = _rtB->Fcn - _rtB->Add1_a;
  }

  if (ssIsSampleHit(S, 1, tid)) {
    /* Gain: '<S19>/Proportional Gain' */
    _rtB->ProportionalGain_d = (*(real_T *)(mxGetData(KPT(S)))) * _rtB->Sum_lv;

    /* Gain: '<S19>/Integral Gain' */
    _rtB->IntegralGain_p = (*(real_T *)(mxGetData(KIT(S)))) * _rtB->Sum_lv;

    /* DiscreteIntegrator: '<S19>/Integrator' */
    _rtB->Integrator_g = 5.0E-6 * _rtB->IntegralGain_p + ((real_T *)ssGetDWork(S,
      2))[0];

    /* Sum: '<S19>/Sum' */
    _rtB->Sum_ib = _rtB->ProportionalGain_d + _rtB->Integrator_g;
  }

  if (ssIsContinuousTask(S, tid)) {
    /* Sum: '<S2>/Sum' */
    _rtB->Sum_h = _rtB->Fcn_h + _rtB->Sum_ib;
  }

  if (ssIsSampleHit(S, 1, tid)) {
    /* Trigonometry: '<S4>/Trigonometric Function1' */
    _rtB->TrigonometricFunction1_h = sin(_rtB->DiscreteTimeIntegrator);
  }

  if (ssIsContinuousTask(S, tid)) {
    /* Product: '<S4>/Product3' */
    _rtB->Product3_f = _rtB->Sum_h * _rtB->TrigonometricFunction1_h;

    /* Sum: '<S4>/Add' */
    _rtB->Add_f = _rtB->Product_g - _rtB->Product3_f;

    /* Product: '<S4>/Product1' */
    _rtB->Product1_fz = _rtB->Sum_h * _rtB->TrigonometricFunction_i;

    /* Product: '<S4>/Product2' */
    _rtB->Product2_g = _rtB->Sum1_o * _rtB->TrigonometricFunction1_h;

    /* Sum: '<S4>/Add1' */
    _rtB->Add1_b = _rtB->Product1_fz + _rtB->Product2_g;

    /* RealImagToComplex: '<S20>/Real-Imag to Complex' */
    _rtB->RealImagtoComplex.re = _rtB->Add_f;
    _rtB->RealImagtoComplex.im = _rtB->Add1_b;

    /* ComplexToMagnitudeAngle: '<S20>/Complex to Magnitude-Angle' */
    _rtB->ComplextoMagnitudeAngle_o1 = DCU2_rt_hypotd_snf
      (_rtB->RealImagtoComplex.re, _rtB->RealImagtoComplex.im);
    _rtB->ComplextoMagnitudeAngle_o2 = DCU2_rt_atan2d_snf
    ...
    if (A > u2) {
      _rtB->Saturation_i = u2;
    } else if (A < u1) {
      _rtB->Saturation_i = u1;
    } else {
      _rtB->Saturation_i = A;
    }
     ...
     */
    _rtB->RelationalOperator = (_rtB->Saturation_i > 0.0);

    /* RelationalOperator: '<S22>/Relational Operator1' incorporates:
     *  Constant: '<S22>/Constant1'
     */
    _rtB->RelationalOperator1 = (_rtB->Saturation_i <= 1.0471975511965976);

    /* Logic: '<S22>/Logical Operator' */
    _rtB->LogicalOperator_l = (_rtB->RelationalOperator &&
      _rtB->RelationalOperator1);

    /* DataTypeConversion: '<S22>/Data Type Conversion' */
    _rtB->DataTypeConversion = _rtB->LogicalOperator_l;

    /* Gain: '<S22>/Gain' */
    _rtB->Gain_a = 1.0 * _rtB->DataTypeConversion;

    /* RelationalOperator: '<S22>/Relational Operator2' incorporates:
     *  Constant: '<S22>/Constant11'
     */
    _rtB->RelationalOperator2 = (_rtB->Saturation_i > 1.0471975511965976);

    /* RelationalOperator: '<S22>/Relational Operator3' incorporates:
     *  Constant: '<S22>/Constant2'
     */
    _rtB->RelationalOperator3 = (_rtB->Saturation_i <= 2.0943951023931953);

    /* Logic: '<S22>/Logical Operator1' */
    _rtB->LogicalOperator1_d = (_rtB->RelationalOperator2 &&
      _rtB->RelationalOperator3);

    /* DataTypeConversion: '<S22>/Data Type Conversion1' */
    _rtB->DataTypeConversion1 = _rtB->LogicalOperator1_d;

    /* Gain: '<S22>/Gain1' */
    _rtB->Gain1_f = 2.0 * _rtB->DataTypeConversion1;

    /* RelationalOperator: '<S22>/Relational Operator4' incorporates:
     *  Constant: '<S22>/Constant3'
     */
    _rtB->RelationalOperator4 = (_rtB->Saturation_i > 2.0943951023931953);

    /* RelationalOperator: '<S22>/Relational Operator5' incorporates:
     *  Constant: '<S22>/Constant4'
     */
    _rtB->RelationalOperator5 = (_rtB->Saturation_i <= 3.1415926535897931);

    /* Logic: '<S22>/Logical Operator2' */
    _rtB->LogicalOperator2_k = (_rtB->RelationalOperator4 &&
      _rtB->RelationalOperator5);

    /* DataTypeConversion: '<S22>/Data Type Conversion2' */
    _rtB->DataTypeConversion2 = _rtB->LogicalOperator2_k;

    /* Gain: '<S22>/Gain2' */
    _rtB->Gain2_p = 3.0 * _rtB->DataTypeConversion2;

    /* RelationalOperator: '<S22>/Relational Operator6' incorporates:
     *  Constant: '<S22>/Constant5'
     */
    _rtB->RelationalOperator6 = (_rtB->Saturation_i >= (-3.1415926535897931));

    /* RelationalOperator: '<S22>/Relational Operator7' incorporates:
     *  Constant: '<S22>/Constant6'
     */
    _rtB->RelationalOperator7 = (_rtB->Saturation_i <= (-2.0943951023931953));

    /* Logic: '<S22>/Logical Operator3' */
    _rtB->LogicalOperator3_f = (_rtB->RelationalOperator6 &&
      _rtB->RelationalOperator7);

    /* DataTypeConversion: '<S22>/Data Type Conversion3' */
    _rtB->DataTypeConversion3 = _rtB->LogicalOperator3_f;

    /* Gain: '<S22>/Gain3' */
    _rtB->Gain3_g = 4.0 * _rtB->DataTypeConversion3;

    /* RelationalOperator: '<S22>/Relational Operator8' incorporates:
     *  Constant: '<S22>/Constant7'
     */
    _rtB->RelationalOperator8 = (_rtB->Saturation_i > (-2.0943951023931953));

    /* RelationalOperator: '<S22>/Relational Operator9' incorporates:
     *  Constant: '<S22>/Constant8'
     */
    _rtB->RelationalOperator9 = (_rtB->Saturation_i <= (-1.0471975511965976));
     ...
     */
    _rtB->RelationalOperator10 = (_rtB->Saturation_i > (-1.0471975511965976));

    /* RelationalOperator: '<S22>/Relational Operator11' incorporates:
     *  Constant: '<S22>/Constant10'
     */
    _rtB->RelationalOperator11 = (_rtB->Saturation_i <= 0.0);
    ...
    /* Sum: '<S22>/Add' */
    _rtB->Add_g = ((((_rtB->Gain_a + _rtB->Gain1_f) + _rtB->Gain2_p) +
                    _rtB->Gain3_g) + _rtB->Gain4) + _rtB->Gain5;

    /* RelationalOperator: '<S23>/Relational Operator' incorporates:
     *  Constant: '<S23>/Constant'
     */
    _rtB->RelationalOperator_o = (_rtB->Saturation_i >= 0.0);

    /* Switch: '<S23>/Switch' */
    if (_rtB->RelationalOperator_o) {
      _rtB->Switch_ow = _rtB->Add_g;
    } else {
      /* Fcn: '<S23>/Fcn' */
      _rtB->Fcn_g = _rtB->Add_g - 6.0;
      _rtB->Switch_ow = _rtB->Fcn_g;
    }

    /* End of Switch: '<S23>/Switch' */

    /* Gain: '<S23>/Gain' */
    _rtB->Gain_c = 1.0471975511965976 * _rtB->Switch_ow;

    /* Sum: '<S23>/Add' incorporates:
     *  Constant: '<S23>/Constant1'
     */
    _rtB->Add_fv = (_rtB->Saturation_i - _rtB->Gain_c) + 1.0471975511965976;

    /* Sum: '<S3>/Add' incorporates:
     *  Inport: '<Root>/Inport2'
     *  Inport: '<Root>/Inport5'
     */
    _rtB->Add_i = *((const real_T **)ssGetInputPortSignalPtrs(S, 2))[0] + *((
      const real_T **)ssGetInputPortSignalPtrs(S, 5))[0];

    /* Fcn: '<S20>/Fcn' */
    _rtB->Fcn_k = 1.5 * _rtB->ComplextoMagnitudeAngle_o1 / (_rtB->Add_i + 1.0);
    ...
    /* MATLAB Function 'DCU2/DCU-Inverter/SVPWM Genratorfxy/Reference voltage orientation /Section-n1': '<S24>:1' */
    /* '<S24>:1:2' */
    /* '<S24>:1:3' */
    /* '<S24>:1:4' */
    if (cos(0.52359877559829882 - _rtB->Add_fv) * _rtB->Saturation1 <
        0.4330127018922193) {
      /* '<S24>:1:5' */
      /* '<S24>:1:6' */
      _rtB->n = 1.0;
    } else if (sin(1.0471975511965976 - _rtB->Add_fv) * _rtB->Saturation1 >
               0.4330127018922193) {
      /* '<S24>:1:7' */
      /* '<S24>:1:8' */
      _rtB->n = 3.0;
    } else if (_rtB->Saturation1 * sin(_rtB->Add_fv) > 0.4330127018922193) {
      /* '<S24>:1:9' */
      /* '<S24>:1:10' */
      _rtB->n = 4.0;
    } else {
     ...
     */
    _rtB->Sum_g = _rtB->Clock - ssGetTStart(S);

    /* Math: '<S30>/Math Function' incorporates:
     *  Constant: '<S30>/Constant'
     */
    _rtB->MathFunction = DCU2_rt_remd_snf(_rtB->Sum_g, 0.0001);

    /* Lookup_n-D: '<S30>/Look-Up Table1' */
    _rtB->LookUpTable1 = DCU2_look1_binlxpw(_rtB->MathFunction,
      DCU2_ConstP.pooled31, DCU2_ConstP.pooled31, 1U);
  ...
  if (ssIsContinuousTask(S, tid)) {
    ...
    /* MATLAB Function 'DCU2/DCU-Inverter/SVPWM Genratorfxy/Time Setting/Triggered/Section-n': '<S28>:1' */
    /* '<S28>:1:2' */
    _rtB->Ta = 0.0;
    ...
    switch ((int32_T)_rtB->n) {
     case 1:
      /* '<S28>:1:7' */
      _rtB->Ta = 2.0 * _rtB->Saturation1 * _rtB->Ts * (cos(_rtB->Add_fv) - sin
        (_rtB->Add_fv) / 1.7320508075688772);

      /* '<S28>:1:8' */
      _rtB->Tb = _rtB->Saturation1 * _rtB->Ts * 4.0 * sin(_rtB->Add_fv) /
        1.7320508075688772;

      /* '<S28>:1:9' */
      _rtB->Tc = (1.0 - (sin(_rtB->Add_fv) / 1.7320508075688772 + cos
                         (_rtB->Add_fv)) * (2.0 * _rtB->Saturation1)) * _rtB->Ts;
      break;

     case 2:
      /* '<S28>:1:11' */
      _rtB->Ta = (1.0 - 4.0 * _rtB->Saturation1 * sin(_rtB->Add_fv) /
                  1.7320508075688772) * _rtB->Ts;

      /* '<S28>:1:12' */
      _rtB->Tb = (1.0 - (cos(_rtB->Add_fv) - sin(_rtB->Add_fv) /
                         1.7320508075688772) * (2.0 * _rtB->Saturation1)) *
        _rtB->Ts;

      /* '<S28>:1:13' */
      _rtB->Tc = ((sin(_rtB->Add_fv) / 1.7320508075688772 + cos(_rtB->Add_fv)) *
                  (2.0 * _rtB->Saturation1) + -1.0) * _rtB->Ts;
      break;

     case 3:
      /* '<S28>:1:15' */
      _rtB->Ta = (2.0 - (sin(_rtB->Add_fv) / 1.7320508075688772 + cos
                         (_rtB->Add_fv)) * (2.0 * _rtB->Saturation1)) * _rtB->Ts;

      /* '<S28>:1:16' */
      _rtB->Tb = ((cos(_rtB->Add_fv) - sin(_rtB->Add_fv) / 1.7320508075688772) *
                  (2.0 * _rtB->Saturation1) + -1.0) * _rtB->Ts;

      /* '<S28>:1:17' */
      _rtB->Tc = 4.0 * _rtB->Ts * _rtB->Saturation1 * sin(_rtB->Add_fv) /
        1.7320508075688772;
      break;
     ...
     case 4:
      ...
      /* '<S28>:1:20' */
      _rtB->Tb = 2.0 * _rtB->Ts * _rtB->Saturation1 * (cos(_rtB->Add_fv) - sin
        (_rtB->Add_fv) / 1.7320508075688772);

      /* '<S28>:1:21' */
      _rtB->Tc = (4.0 * _rtB->Saturation1 * sin(_rtB->Add_fv) /
    ...
    switch ((int32_T)_rtB->Add_g) {
     case 1:
      _rtB->MultiportSwitch_p[0] = _rtB->Ta;
      _rtB->MultiportSwitch_p[1] = _rtB->Tc;
      _rtB->MultiportSwitch_p[2] = _rtB->Tb;
      break;

     case 2:
      _rtB->MultiportSwitch_p[0] = _rtB->Ta;
      _rtB->MultiportSwitch_p[1] = _rtB->Tb;
      _rtB->MultiportSwitch_p[2] = _rtB->Tc;
      break;
    ...
    /* Gain: '<S31>/Gain1' */
    _rtB->Gain1_e = 0.25 * _rtB->MultiportSwitch_p[0];

    /* RelationalOperator: '<S31>/Relational Operator' */
    _rtB->RelationalOperator_g = (_rtB->Output > _rtB->Gain1_e);

    /* Gain: '<S31>/Gain2' */
    _rtB->Gain2_j = 0.5 * _rtB->MultiportSwitch_p[1];

    /* Sum: '<S31>/Add1' */
    _rtB->Add1_h = _rtB->Gain1_e + _rtB->Gain2_j;

    /* RelationalOperator: '<S31>/Relational Operator1' */
    _rtB->RelationalOperator1_a = (_rtB->Output > _rtB->Add1_h);

    /* Gain: '<S31>/Gain3' */
    _rtB->Gain3_k = 0.5 * _rtB->MultiportSwitch_p[2];

    /* Sum: '<S31>/Add2' */
    _rtB->Add2_a = _rtB->Add1_h + _rtB->Gain3_k;

    /* RelationalOperator: '<S31>/Relational Operator2' */
    _rtB->RelationalOperator2_d = (_rtB->Output > _rtB->Add2_a);

    /* Gain: '<S31>/Gain4' */
    _rtB->Gain4_g = 0.5 * _rtB->MultiportSwitch_p[0];

    /* Sum: '<S31>/Add3' */
    _rtB->Add3 = _rtB->Add2_a + _rtB->Gain4_g;

    /* RelationalOperator: '<S31>/Relational Operator3' */
    _rtB->RelationalOperator3_j = (_rtB->Output > _rtB->Add3);

    /* Sum: '<S31>/Add4' */
    _rtB->Add4 = _rtB->Add3 + _rtB->Gain3_k;

    /* RelationalOperator: '<S31>/Relational Operator4' */
    _rtB->RelationalOperator4_p = (_rtB->Output > _rtB->Add4);

    /* Sum: '<S31>/Add5' */
    _rtB->Add5 = _rtB->Add4 + _rtB->Gain2_j;

    /* RelationalOperator: '<S31>/Relational Operator5' */
    _rtB->RelationalOperator5_f = (_rtB->Output > _rtB->Add5);

    /* DataTypeConversion: '<S31>/Data Type Conversion' */
    _rtB->DataTypeConversion_l[0] = _rtB->RelationalOperator_g;
    _rtB->DataTypeConversion_l[1] = _rtB->RelationalOperator1_a;
    _rtB->DataTypeConversion_l[2] = _rtB->RelationalOperator2_d;
    _rtB->DataTypeConversion_l[3] = _rtB->RelationalOperator3_j;
    _rtB->DataTypeConversion_l[4] = _rtB->RelationalOperator4_p;
    _rtB->DataTypeConversion_l[5] = _rtB->RelationalOperator5_f;

    /* Gain: '<S31>/Gain5' */
    for (i = 0; i < 6; i++) {
      _rtB->Gain5_n[i] = 1.0 * _rtB->DataTypeConversion_l[i];
    }

    /* End of Gain: '<S31>/Gain5' */

    /* Sum: '<S31>/Add6' */
    _rtB->Add6 = ((((_rtB->Gain5_n[0] + _rtB->Gain5_n[1]) + _rtB->Gain5_n[2]) +
                   _rtB->Gain5_n[3]) + _rtB->Gain5_n[4]) + _rtB->Gain5_n[5];
     ...
     case 1:
      ...
      switch ((int32_T)_rtB->n) {
       case 1:
        ...
        _rtB->MultiportSwitch_o[0] = _rtB->MultiportSwitch_f[0];
        _rtB->MultiportSwitch_o[1] = _rtB->MultiportSwitch_f[1];
        _rtB->MultiportSwitch_o[2] = _rtB->MultiportSwitch_f[2];
        break;
       ...
       case 2:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_fb[0] = 1.0;
          _rtB->MultiportSwitch_fb[1] = 0.0;
          _rtB->MultiportSwitch_fb[2] = 0.0;
          break;

         case 2:
          _rtB->MultiportSwitch_fb[0] = 1.0;
          _rtB->MultiportSwitch_fb[1] = 0.0;
          _rtB->MultiportSwitch_fb[2] = (-1.0);
          break;

         case 3:
          _rtB->MultiportSwitch_fb[0] = 0.0;
          _rtB->MultiportSwitch_fb[1] = 0.0;
          _rtB->MultiportSwitch_fb[2] = (-1.0);
          break;
        ...
        _rtB->MultiportSwitch_o[0] = _rtB->MultiportSwitch_fb[0];
        _rtB->MultiportSwitch_o[1] = _rtB->MultiportSwitch_fb[1];
        _rtB->MultiportSwitch_o[2] = _rtB->MultiportSwitch_fb[2];
        break;
       ...
       case 3:
        ...
        _rtB->MultiportSwitch_o[0] = _rtB->MultiportSwitch_g[0];
        _rtB->MultiportSwitch_o[1] = _rtB->MultiportSwitch_g[1];
        _rtB->MultiportSwitch_o[2] = _rtB->MultiportSwitch_g[2];
        break;
       ...
       default:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_j[0] = 1.0;
          _rtB->MultiportSwitch_j[1] = 1.0;
          _rtB->MultiportSwitch_j[2] = 0.0;
          break;

         case 2:
          _rtB->MultiportSwitch_j[0] = 1.0;
          _rtB->MultiportSwitch_j[1] = 1.0;
          _rtB->MultiportSwitch_j[2] = (-1.0);
          break;

         case 3:
          _rtB->MultiportSwitch_j[0] = 1.0;
          _rtB->MultiportSwitch_j[1] = 0.0;
          _rtB->MultiportSwitch_j[2] = (-1.0);
          break;

         case 4:
          _rtB->MultiportSwitch_j[0] = 0.0;
          _rtB->MultiportSwitch_j[1] = 0.0;
          _rtB->MultiportSwitch_j[2] = (-1.0);
          break;
        ...
        _rtB->MultiportSwitch_o[0] = _rtB->MultiportSwitch_j[0];
        _rtB->MultiportSwitch_o[1] = _rtB->MultiportSwitch_j[1];
        _rtB->MultiportSwitch_o[2] = _rtB->MultiportSwitch_j[2];
        break;
      }

      /* End of MultiPortSwitch: '<S32>/Multiport Switch' */
      _rtB->MultiportSwitch_b[0] = _rtB->MultiportSwitch_o[0];
      _rtB->MultiportSwitch_b[1] = _rtB->MultiportSwitch_o[1];
      _rtB->MultiportSwitch_b[2] = _rtB->MultiportSwitch_o[2];
      break;
     ...
     case 2:
      ...
      switch ((int32_T)_rtB->n) {
       case 1:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_p3[0] = 1.0;
          _rtB->MultiportSwitch_p3[1] = 1.0;
          _rtB->MultiportSwitch_p3[2] = 0.0;
          break;

         case 2:
          _rtB->MultiportSwitch_p3[0] = 0.0;
          _rtB->MultiportSwitch_p3[1] = 1.0;
          _rtB->MultiportSwitch_p3[2] = 0.0;
          break;
        ...
        _rtB->MultiportSwitch_mr[0] = _rtB->MultiportSwitch_p3[0];
        _rtB->MultiportSwitch_mr[1] = _rtB->MultiportSwitch_p3[1];
        _rtB->MultiportSwitch_mr[2] = _rtB->MultiportSwitch_p3[2];
        break;
       ...
       case 2:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_gc[0] = 1.0;
          _rtB->MultiportSwitch_gc[1] = 1.0;
          _rtB->MultiportSwitch_gc[2] = 0.0;
          break;

         case 2:
          _rtB->MultiportSwitch_gc[0] = 0.0;
          _rtB->MultiportSwitch_gc[1] = 1.0;
          _rtB->MultiportSwitch_gc[2] = 0.0;
          break;
         ...
         case 3:
          _rtB->MultiportSwitch_gc[0] = 0.0;
          _rtB->MultiportSwitch_gc[1] = 1.0;
          _rtB->MultiportSwitch_gc[2] = (-1.0);
          break;

         case 4:
          _rtB->MultiportSwitch_gc[0] = 0.0;
          _rtB->MultiportSwitch_gc[1] = 0.0;
          _rtB->MultiportSwitch_gc[2] = (-1.0);
          break;
        ...
        _rtB->MultiportSwitch_mr[0] = _rtB->MultiportSwitch_gc[0];
        _rtB->MultiportSwitch_mr[1] = _rtB->MultiportSwitch_gc[1];
        _rtB->MultiportSwitch_mr[2] = _rtB->MultiportSwitch_gc[2];
        break;
       ...
       case 3:
        ...
        _rtB->MultiportSwitch_mr[0] = _rtB->MultiportSwitch_e[0];
        _rtB->MultiportSwitch_mr[1] = _rtB->MultiportSwitch_e[1];
        _rtB->MultiportSwitch_mr[2] = _rtB->MultiportSwitch_e[2];
        break;
       ...
       default:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_h[0] = 0.0;
          _rtB->MultiportSwitch_h[1] = 1.0;
          _rtB->MultiportSwitch_h[2] = 0.0;
          break;

         case 2:
          _rtB->MultiportSwitch_h[0] = 0.0;
          _rtB->MultiportSwitch_h[1] = 1.0;
          _rtB->MultiportSwitch_h[2] = (-1.0);
          break;

         case 3:
          _rtB->MultiportSwitch_h[0] = (-1.0);
          _rtB->MultiportSwitch_h[1] = 1.0;
          _rtB->MultiportSwitch_h[2] = (-1.0);
          break;
        ...
        _rtB->MultiportSwitch_mr[0] = _rtB->MultiportSwitch_h[0];
        _rtB->MultiportSwitch_mr[1] = _rtB->MultiportSwitch_h[1];
        _rtB->MultiportSwitch_mr[2] = _rtB->MultiportSwitch_h[2];
        break;
      }

      /* End of MultiPortSwitch: '<S33>/Multiport Switch' */
      _rtB->MultiportSwitch_b[0] = _rtB->MultiportSwitch_mr[0];
      _rtB->MultiportSwitch_b[1] = _rtB->MultiportSwitch_mr[1];
      _rtB->MultiportSwitch_b[2] = _rtB->MultiportSwitch_mr[2];
      break;
     ...
     case 3:
      ...
      switch ((int32_T)_rtB->n) {
       case 1:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_kx[0] = 0.0;
          _rtB->MultiportSwitch_kx[1] = 1.0;
          _rtB->MultiportSwitch_kx[2] = 0.0;
          break;

         case 2:
          _rtB->MultiportSwitch_kx[0] = 0.0;
          _rtB->MultiportSwitch_kx[1] = 0.0;
          _rtB->MultiportSwitch_kx[2] = 0.0;
          break;

         case 3:
          _rtB->MultiportSwitch_kx[0] = (-1.0);
          _rtB->MultiportSwitch_kx[1] = 0.0;
          _rtB->MultiportSwitch_kx[2] = 0.0;
          break;
        ...
        _rtB->MultiportSwitch_fh[0] = _rtB->MultiportSwitch_kx[0];
        _rtB->MultiportSwitch_fh[1] = _rtB->MultiportSwitch_kx[1];
        _rtB->MultiportSwitch_fh[2] = _rtB->MultiportSwitch_kx[2];
        break;
       ...
       case 2:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_oq[0] = 0.0;
          _rtB->MultiportSwitch_oq[1] = 1.0;
          _rtB->MultiportSwitch_oq[2] = 0.0;
          break;

         case 2:
          _rtB->MultiportSwitch_oq[0] = (-1.0);
          _rtB->MultiportSwitch_oq[1] = 1.0;
          _rtB->MultiportSwitch_oq[2] = 0.0;
          break;
        ...
        _rtB->MultiportSwitch_fh[0] = _rtB->MultiportSwitch_oq[0];
        _rtB->MultiportSwitch_fh[1] = _rtB->MultiportSwitch_oq[1];
        _rtB->MultiportSwitch_fh[2] = _rtB->MultiportSwitch_oq[2];
        break;
       ...
       case 3:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_g1[0] = 0.0;
          _rtB->MultiportSwitch_g1[1] = 1.0;
          _rtB->MultiportSwitch_g1[2] = 0.0;
          break;

         case 2:
          _rtB->MultiportSwitch_g1[0] = (-1.0);
          _rtB->MultiportSwitch_g1[1] = 1.0;
          _rtB->MultiportSwitch_g1[2] = 0.0;
          break;
         ...
         case 3:
          _rtB->MultiportSwitch_g1[0] = (-1.0);
          _rtB->MultiportSwitch_g1[1] = 1.0;
          _rtB->MultiportSwitch_g1[2] = (-1.0);
          break;

         case 4:
          _rtB->MultiportSwitch_g1[0] = (-1.0);
          _rtB->MultiportSwitch_g1[1] = 0.0;
          _rtB->MultiportSwitch_g1[2] = (-1.0);
          break;
        ...
        _rtB->MultiportSwitch_fh[0] = _rtB->MultiportSwitch_g1[0];
        _rtB->MultiportSwitch_fh[1] = _rtB->MultiportSwitch_g1[1];
        _rtB->MultiportSwitch_fh[2] = _rtB->MultiportSwitch_g1[2];
        break;
       ...
       default:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_bu[0] = 0.0;
          _rtB->MultiportSwitch_bu[1] = 1.0;
          _rtB->MultiportSwitch_bu[2] = 1.0;
          break;

         case 2:
          _rtB->MultiportSwitch_bu[0] = (-1.0);
          _rtB->MultiportSwitch_bu[1] = 1.0;
          _rtB->MultiportSwitch_bu[2] = 1.0;
          break;
         ...
         case 3:
          _rtB->MultiportSwitch_bu[0] = (-1.0);
          _rtB->MultiportSwitch_bu[1] = 1.0;
          _rtB->MultiportSwitch_bu[2] = 0.0;
          break;

         case 4:
          _rtB->MultiportSwitch_bu[0] = (-1.0);
          _rtB->MultiportSwitch_bu[1] = 0.0;
          _rtB->MultiportSwitch_bu[2] = 0.0;
          break;
        ...
        _rtB->MultiportSwitch_fh[0] = _rtB->MultiportSwitch_bu[0];
        _rtB->MultiportSwitch_fh[1] = _rtB->MultiportSwitch_bu[1];
        _rtB->MultiportSwitch_fh[2] = _rtB->MultiportSwitch_bu[2];
        break;
      }

      /* End of MultiPortSwitch: '<S34>/Multiport Switch' */
      _rtB->MultiportSwitch_b[0] = _rtB->MultiportSwitch_fh[0];
      _rtB->MultiportSwitch_b[1] = _rtB->MultiportSwitch_fh[1];
      _rtB->MultiportSwitch_b[2] = _rtB->MultiportSwitch_fh[2];
      break;
     ...
     case 4:
      ...
      switch ((int32_T)_rtB->n) {
       case 1:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_m1[0] = 0.0;
          _rtB->MultiportSwitch_m1[1] = 1.0;
          _rtB->MultiportSwitch_m1[2] = 1.0;
          break;

         case 2:
          _rtB->MultiportSwitch_m1[0] = 0.0;
          _rtB->MultiportSwitch_m1[1] = 0.0;
          _rtB->MultiportSwitch_m1[2] = 1.0;
          break;
         ...
         case 3:
          _rtB->MultiportSwitch_m1[0] = 0.0;
          _rtB->MultiportSwitch_m1[1] = 0.0;
          _rtB->MultiportSwitch_m1[2] = 0.0;
          break;

         case 4:
          _rtB->MultiportSwitch_m1[0] = (-1.0);
          _rtB->MultiportSwitch_m1[1] = 0.0;
          _rtB->MultiportSwitch_m1[2] = 0.0;
          break;
        ...
        _rtB->MultiportSwitch_g5[0] = _rtB->MultiportSwitch_m1[0];
        _rtB->MultiportSwitch_g5[1] = _rtB->MultiportSwitch_m1[1];
        _rtB->MultiportSwitch_g5[2] = _rtB->MultiportSwitch_m1[2];
        break;
       ...
       case 2:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_pj[0] = 0.0;
          _rtB->MultiportSwitch_pj[1] = 1.0;
          _rtB->MultiportSwitch_pj[2] = 1.0;
          break;

         case 2:
          _rtB->MultiportSwitch_pj[0] = 0.0;
          _rtB->MultiportSwitch_pj[1] = 0.0;
          _rtB->MultiportSwitch_pj[2] = 1.0;
          break;

         case 3:
          _rtB->MultiportSwitch_pj[0] = (-1.0);
          _rtB->MultiportSwitch_pj[1] = 0.0;
          _rtB->MultiportSwitch_pj[2] = 1.0;
          break;
        ...
        _rtB->MultiportSwitch_g5[0] = _rtB->MultiportSwitch_pj[0];
        _rtB->MultiportSwitch_g5[1] = _rtB->MultiportSwitch_pj[1];
        _rtB->MultiportSwitch_g5[2] = _rtB->MultiportSwitch_pj[2];
        break;
       ...
       case 3:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_jt[0] = 0.0;
          _rtB->MultiportSwitch_jt[1] = 1.0;
          _rtB->MultiportSwitch_jt[2] = 1.0;
          break;

         case 2:
          _rtB->MultiportSwitch_jt[0] = (-1.0);
          _rtB->MultiportSwitch_jt[1] = 1.0;
          _rtB->MultiportSwitch_jt[2] = 1.0;
          break;
        ...
        _rtB->MultiportSwitch_g5[0] = _rtB->MultiportSwitch_jt[0];
        _rtB->MultiportSwitch_g5[1] = _rtB->MultiportSwitch_jt[1];
        _rtB->MultiportSwitch_g5[2] = _rtB->MultiportSwitch_jt[2];
        break;
       ...
       default:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_g2[0] = 0.0;
          _rtB->MultiportSwitch_g2[1] = 0.0;
          _rtB->MultiportSwitch_g2[2] = 1.0;
          break;

         case 2:
          _rtB->MultiportSwitch_g2[0] = (-1.0);
          _rtB->MultiportSwitch_g2[1] = 0.0;
          _rtB->MultiportSwitch_g2[2] = 1.0;
          break;
        ...
        _rtB->MultiportSwitch_g5[0] = _rtB->MultiportSwitch_g2[0];
        _rtB->MultiportSwitch_g5[1] = _rtB->MultiportSwitch_g2[1];
        _rtB->MultiportSwitch_g5[2] = _rtB->MultiportSwitch_g2[2];
        break;
      }

      /* End of MultiPortSwitch: '<S35>/Multiport Switch' */
      _rtB->MultiportSwitch_b[0] = _rtB->MultiportSwitch_g5[0];
      _rtB->MultiportSwitch_b[1] = _rtB->MultiportSwitch_g5[1];
      _rtB->MultiportSwitch_b[2] = _rtB->MultiportSwitch_g5[2];
      break;
     ...
     case 5:
      ...
      switch ((int32_T)_rtB->n) {
       case 1:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_fg[0] = 0.0;
          _rtB->MultiportSwitch_fg[1] = 0.0;
          _rtB->MultiportSwitch_fg[2] = 1.0;
          break;

         case 2:
          _rtB->MultiportSwitch_fg[0] = 0.0;
          _rtB->MultiportSwitch_fg[1] = 0.0;
          _rtB->MultiportSwitch_fg[2] = 0.0;
          break;

         case 3:
          _rtB->MultiportSwitch_fg[0] = 0.0;
          _rtB->MultiportSwitch_fg[1] = (-1.0);
          _rtB->MultiportSwitch_fg[2] = 0.0;
          break;

         case 4:
          _rtB->MultiportSwitch_fg[0] = (-1.0);
          _rtB->MultiportSwitch_fg[1] = (-1.0);
          _rtB->MultiportSwitch_fg[2] = 0.0;
          break;
        ...
        _rtB->MultiportSwitch_mb[0] = _rtB->MultiportSwitch_fg[0];
        _rtB->MultiportSwitch_mb[1] = _rtB->MultiportSwitch_fg[1];
        _rtB->MultiportSwitch_mb[2] = _rtB->MultiportSwitch_fg[2];
        break;
       ...
       case 2:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_gw[0] = 0.0;
          _rtB->MultiportSwitch_gw[1] = 0.0;
          _rtB->MultiportSwitch_gw[2] = 1.0;
          break;

         case 2:
          _rtB->MultiportSwitch_gw[0] = 0.0;
          _rtB->MultiportSwitch_gw[1] = (-1.0);
          _rtB->MultiportSwitch_gw[2] = 1.0;
          break;
         ...
         case 3:
          _rtB->MultiportSwitch_gw[0] = 0.0;
          _rtB->MultiportSwitch_gw[1] = (-1.0);
          _rtB->MultiportSwitch_gw[2] = 0.0;
          break;

         case 4:
          _rtB->MultiportSwitch_gw[0] = (-1.0);
          _rtB->MultiportSwitch_gw[1] = (-1.0);
          _rtB->MultiportSwitch_gw[2] = 0.0;
          break;
        ...
        _rtB->MultiportSwitch_mb[0] = _rtB->MultiportSwitch_gw[0];
        _rtB->MultiportSwitch_mb[1] = _rtB->MultiportSwitch_gw[1];
        _rtB->MultiportSwitch_mb[2] = _rtB->MultiportSwitch_gw[2];
        break;
       ...
       case 3:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_ei[0] = 0.0;
          _rtB->MultiportSwitch_ei[1] = 0.0;
          _rtB->MultiportSwitch_ei[2] = 1.0;
          break;

         case 2:
          _rtB->MultiportSwitch_ei[0] = 0.0;
          _rtB->MultiportSwitch_ei[1] = (-1.0);
          _rtB->MultiportSwitch_ei[2] = 1.0;
          break;

         case 3:
          _rtB->MultiportSwitch_ei[0] = (-1.0);
          _rtB->MultiportSwitch_ei[1] = (-1.0);
          _rtB->MultiportSwitch_ei[2] = 1.0;
          break;
        ...
        _rtB->MultiportSwitch_mb[0] = _rtB->MultiportSwitch_ei[0];
        _rtB->MultiportSwitch_mb[1] = _rtB->MultiportSwitch_ei[1];
        _rtB->MultiportSwitch_mb[2] = _rtB->MultiportSwitch_ei[2];
        break;
       ...
       default:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_ml[0] = 1.0;
          _rtB->MultiportSwitch_ml[1] = 0.0;
          _rtB->MultiportSwitch_ml[2] = 1.0;
          break;

         case 2:
          _rtB->MultiportSwitch_ml[0] = 1.0;
          _rtB->MultiportSwitch_ml[1] = (-1.0);
          _rtB->MultiportSwitch_ml[2] = 1.0;
          break;

         case 3:
          _rtB->MultiportSwitch_ml[0] = 0.0;
          _rtB->MultiportSwitch_ml[1] = (-1.0);
          _rtB->MultiportSwitch_ml[2] = 1.0;
          break;
        ...
        _rtB->MultiportSwitch_mb[0] = _rtB->MultiportSwitch_ml[0];
        _rtB->MultiportSwitch_mb[1] = _rtB->MultiportSwitch_ml[1];
        _rtB->MultiportSwitch_mb[2] = _rtB->MultiportSwitch_ml[2];
        break;
      }

      /* End of MultiPortSwitch: '<S36>/Multiport Switch' */
      _rtB->MultiportSwitch_b[0] = _rtB->MultiportSwitch_mb[0];
      _rtB->MultiportSwitch_b[1] = _rtB->MultiportSwitch_mb[1];
      _rtB->MultiportSwitch_b[2] = _rtB->MultiportSwitch_mb[2];
      break;
     ...
     default:
      ...
      switch ((int32_T)_rtB->n) {
       case 1:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_ep[0] = 1.0;
          _rtB->MultiportSwitch_ep[1] = 0.0;
          _rtB->MultiportSwitch_ep[2] = 1.0;
          break;

         case 2:
          _rtB->MultiportSwitch_ep[0] = 1.0;
          _rtB->MultiportSwitch_ep[1] = 0.0;
          _rtB->MultiportSwitch_ep[2] = 0.0;
          break;

         case 3:
          _rtB->MultiportSwitch_ep[0] = 0.0;
          _rtB->MultiportSwitch_ep[1] = 0.0;
          _rtB->MultiportSwitch_ep[2] = 0.0;
          break;
        ...
        _rtB->MultiportSwitch_ok[0] = _rtB->MultiportSwitch_ep[0];
        _rtB->MultiportSwitch_ok[1] = _rtB->MultiportSwitch_ep[1];
        _rtB->MultiportSwitch_ok[2] = _rtB->MultiportSwitch_ep[2];
        break;
       ...
       case 2:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_na[0] = 1.0;
          _rtB->MultiportSwitch_na[1] = 0.0;
          _rtB->MultiportSwitch_na[2] = 1.0;
          break;

         case 2:
          _rtB->MultiportSwitch_na[0] = 1.0;
          _rtB->MultiportSwitch_na[1] = 0.0;
          _rtB->MultiportSwitch_na[2] = 0.0;
          break;

         case 3:
          _rtB->MultiportSwitch_na[0] = 1.0;
          _rtB->MultiportSwitch_na[1] = (-1.0);
          _rtB->MultiportSwitch_na[2] = 0.0;
          break;

         case 4:
          _rtB->MultiportSwitch_na[0] = 0.0;
          _rtB->MultiportSwitch_na[1] = (-1.0);
          _rtB->MultiportSwitch_na[2] = 0.0;
          break;
        ...
        _rtB->MultiportSwitch_ok[0] = _rtB->MultiportSwitch_na[0];
        _rtB->MultiportSwitch_ok[1] = _rtB->MultiportSwitch_na[1];
        _rtB->MultiportSwitch_ok[2] = _rtB->MultiportSwitch_na[2];
        break;
       ...
       case 3:
        ...
        _rtB->MultiportSwitch_ok[0] = _rtB->MultiportSwitch_d[0];
        _rtB->MultiportSwitch_ok[1] = _rtB->MultiportSwitch_d[1];
        _rtB->MultiportSwitch_ok[2] = _rtB->MultiportSwitch_d[2];
        break;
       ...
       default:
        ...
        switch ((int32_T)_rtB->Add7) {
         case 1:
          _rtB->MultiportSwitch_h5[0] = 1.0;
          _rtB->MultiportSwitch_h5[1] = 0.0;
          _rtB->MultiportSwitch_h5[2] = 0.0;
          break;

         case 2:
          _rtB->MultiportSwitch_h5[0] = 1.0;
          _rtB->MultiportSwitch_h5[1] = (-1.0);
          _rtB->MultiportSwitch_h5[2] = 0.0;
          break;
         ...
         case 3:
          _rtB->MultiportSwitch_h5[0] = 1.0;
          _rtB->MultiportSwitch_h5[1] = (-1.0);
          _rtB->MultiportSwitch_h5[2] = (-1.0);
          break;

         case 4:
          _rtB->MultiportSwitch_h5[0] = 0.0;
          _rtB->MultiportSwitch_h5[1] = (-1.0);
          _rtB->MultiportSwitch_h5[2] = (-1.0);
          break;
        ...
        _rtB->MultiportSwitch_ok[0] = _rtB->MultiportSwitch_h5[0];
        _rtB->MultiportSwitch_ok[1] = _rtB->MultiportSwitch_h5[1];
        _rtB->MultiportSwitch_ok[2] = _rtB->MultiportSwitch_h5[2];
        break;
      }

      /* End of MultiPortSwitch: '<S37>/Multiport Switch' */
      _rtB->MultiportSwitch_b[0] = _rtB->MultiportSwitch_ok[0];
      _rtB->MultiportSwitch_b[1] = _rtB->MultiportSwitch_ok[1];
      _rtB->MultiportSwitch_b[2] = _rtB->MultiportSwitch_ok[2];
      break;
    }
    ...
    /* Clock: '<S91>/Clock' */
    _rtB->Clock_i = ssGetT(S);

    /* Sum: '<S91>/Sum' incorporates:
     *  S-Function (sfun_tstart): '<S91>/startTime'
     */
    _rtB->Sum_b = _rtB->Clock_i - ssGetTStart(S);

    /* Math: '<S91>/Math Function' incorporates:
     *  Constant: '<S91>/Constant'
     */
    _rtB->MathFunction_b = DCU2_rt_remd_snf(_rtB->Sum_b, 0.0008);

    /* Lookup_n-D: '<S91>/Look-Up Table1' */
    _rtB->LookUpTable1_m = DCU2_look1_binlxpw(_rtB->MathFunction_b,
      DCU2_ConstP.pooled59, DCU2_ConstP.LookUpTable1_tableDat, 2U);

    /* SignalConversion: '<S91>/Output' */
    _rtB->Output_h = _rtB->LookUpTable1_m;

    /* Sum: '<S87>/Sum' incorporates:
     *  Constant: '<S1>/Ud+'
     */
    _rtB->Sum_iz = 2600.0 - _rtB->Add_i;
  }

  if (ssIsSampleHit(S, 1, tid)) {
    /* DiscreteIntegrator: '<S92>/Integrator' */
    _rtB->Integrator_gc = ((real_T *)ssGetDWork(S, 3))[0];

    /* Sum: '<S92>/Sum' */
    _rtB->Sum_c = _rtB->Sum_iz + _rtB->Integrator_gc;

    /* Gain: '<S92>/Proportional Gain' */
    _rtB->ProportionalGain_k = 0.5 * _rtB->Sum_c;
  }
  ...
  if (ssIsContinuousTask(S, tid)) {
     ...
     *  Inport: '<Root>/Inport1'
     */
    _rtB->Divide_e = _rtB->Add_i * *((const real_T **)ssGetInputPortSignalPtrs(S,
      1))[0] / 1500.0;

    /* Sum: '<S87>/Sum1' */
    _rtB->Sum1_a = _rtB->ProportionalGain_k + _rtB->Divide_e;

    /* Clock: '<S87>/Clock' */
    _rtB->Clock_p = ssGetT(S);

    /* Product: '<S87>/Product2' incorporates:
     *  Constant: '<S87>/w'
     */
    _rtB->Product2_j = 314.15926535897933 * _rtB->Clock_p;

    /* Trigonometry: '<S87>/Sin(wt)' */
    _rtB->Sinwt = sin(_rtB->Product2_j);

    /* Product: '<S87>/Product1' */
    _rtB->Product1_b = _rtB->Sum1_a * _rtB->Sinwt;

    /* Sum: '<S87>/Sum2' incorporates:
     *  Inport: '<Root>/Inport4'
     */
    _rtB->Sum2 = _rtB->Product1_b - *((const real_T **)ssGetInputPortSignalPtrs
      (S, 4))[0];
     ...
     *  Constant: '<S87>/Rn'
     */
    _rtB->Product5 = _rtB->Sum1_a * 0.2 * _rtB->Sinwt;

    /* Trigonometry: '<S87>/Cos(wt)' */
    _rtB->Coswt = cos(_rtB->Product2_j);

    /* Product: '<S87>/Product4' */
    _rtB->Product4 = _rtB->Sum1_a * DCU2_rtC(S)->Product3 * _rtB->Coswt;

    /* Sum: '<S87>/Add' incorporates:
     *  Inport: '<Root>/Inport3'
     */
    _rtB->Add_h = (*((const real_T **)ssGetInputPortSignalPtrs(S, 3))[0] -
                   _rtB->Product5) - _rtB->Product4;

    /* Sum: '<S87>/Sum3' */
    _rtB->Sum3 = _rtB->Add_h - _rtB->G;
    ...
    _rtB->RelationalOperator_a = (_rtB->Output_h <= _rtB->Uza7);

    /* Gain: '<S86>/Uza1' */
    _rtB->Uza1 = (uint8_T)(_rtB->RelationalOperator_a ? ((uint8_T)128U) : 0);

    /* Gain: '<S86>/Uza' */
    _rtB->Uza = (-1.0) * _rtB->Output_h;
    ...
    /* Sum: '<S86>/Add' */
    _rtB->Add_o = (int8_T)((_rtB->Uza1 + _rtB->Uza2) >> 1);

    /* Clock: '<S90>/Clock' */
    _rtB->Clock_o = ssGetT(S);

    /* Sum: '<S90>/Sum' incorporates:
     *  S-Function (sfun_tstart): '<S90>/startTime'
     */
    _rtB->Sum_d = _rtB->Clock_o - ssGetTStart(S);

    /* Math: '<S90>/Math Function' incorporates:
     *  Constant: '<S90>/Constant'
     */
    _rtB->MathFunction_k = DCU2_rt_remd_snf(_rtB->Sum_d, 0.0008);

    /* Lookup_n-D: '<S90>/Look-Up Table1' */
    _rtB->LookUpTable1_a = DCU2_look1_binlxpw(_rtB->MathFunction_k,
      DCU2_ConstP.pooled59, DCU2_ConstP.LookUpTable1_tableD_d, 2U);

    /* SignalConversion: '<S90>/Output' */
    _rtB->Output_a = _rtB->LookUpTable1_a;

    /* Gain: '<S86>/Uza3' */
    _rtB->Uza3 = (-1.0) * _rtB->G1;

    /* RelationalOperator: '<S86>/Relational Operator2' */
    _rtB->RelationalOperator2_i = (_rtB->Output_a <= _rtB->Uza3);

    /* Gain: '<S86>/Uza5' */
    _rtB->Uza5 = (uint8_T)(_rtB->RelationalOperator2_i ? ((uint8_T)128U) : 0);

    /* Gain: '<S86>/Uza4' */
    _rtB->Uza4 = (-1.0) * _rtB->Output_a;

    /* RelationalOperator: '<S86>/Relational Operator3' */
    _rtB->RelationalOperator3_m = (_rtB->Uza4 >= _rtB->Uza3);

    /* Gain: '<S86>/Uza6' */
    _rtB->Uza6 = (int8_T)(_rtB->RelationalOperator3_m ? (-128) : 0);

    /* Sum: '<S86>/Add1' */
    _rtB->Add1_mv = (int8_T)((_rtB->Uza5 + _rtB->Uza6) >> 1);

    /* Sum: '<S85>/Add' incorporates:
     *  Inport: '<Root>/Inport2'
     *  Inport: '<Root>/Inport5'
     */
    _rtB->Add_d = *((const real_T **)ssGetInputPortSignalPtrs(S, 5))[0] - *((
  ...
  if (ssIsContinuousTask(S, tid)) {
     ...
     *  Inport: '<Root>/Inport4'
     */
    _rtB->Product_d = *((const real_T **)ssGetInputPortSignalPtrs(S, 4))[0] *
      _rtB->Relay * *((const real_T **)ssGetInputPortSignalPtrs(S, 3))[0];

    /* MATLAB Function: '<S85>/NPC-Function' */
    /* MATLAB Function 'DCU2/DCU-Rectifier/NPC-fengxiaoyun/NPC-Function': '<S88>:1' */
    /* '<S88>:1:3' */
    _rtB->FLAG = 1.0;
    if (_rtB->Product_d > 0.0) {
      /* '<S88>:1:4' */
      if ((_rtB->Add_o == 64) && (_rtB->Add1_mv == 0)) {
        /* '<S88>:1:6' */
        _rtB->FLAG = 2.0;
      } else {
        if ((_rtB->Add_o == 0) && (_rtB->Add1_mv == 64)) {
          /* '<S88>:1:8' */
          _rtB->FLAG = 3.0;
        }
      }
    ...
    switch ((int32_T)_rtB->FLAG) {
     case 1:
      _rtB->MultiportSwitch_n[0] = (real_T)_rtB->Add_o * 0.015625;
      _rtB->MultiportSwitch_n[1] = (real_T)_rtB->Add1_mv * 0.015625;
      break;
     ...
     */
    _rtB->Add_nt[0] = _rtB->MultiportSwitch_n[0] + 2.0;
    _rtB->Add_nt[1] = _rtB->MultiportSwitch_n[1] + 2.0;
     ...
     *  Constant: '<S89>/S = Ud'
     */
    switch ((int32_T)_rtB->Add_nt[1]) {
     case 1:
      _rtB->MultiportSwitch1_k[0] = 0.0;
      _rtB->MultiportSwitch1_k[1] = 0.0;
      _rtB->MultiportSwitch1_k[2] = 1.0;
      _rtB->MultiportSwitch1_k[3] = 1.0;
      break;

     case 2:
      _rtB->MultiportSwitch1_k[0] = 0.0;
      _rtB->MultiportSwitch1_k[1] = 1.0;
      _rtB->MultiportSwitch1_k[2] = 1.0;
      _rtB->MultiportSwitch1_k[3] = 0.0;
      break;

     default:
      _rtB->MultiportSwitch1_k[0] = 1.0;
      _rtB->MultiportSwitch1_k[1] = 1.0;
      _rtB->MultiportSwitch1_k[2] = 0.0;
      _rtB->MultiportSwitch1_k[3] = 0.0;
      break;
    }
    ...
    /* Outport: '<Root>/SPWM' */
    ((real_T *)ssGetOutputPortSignal(S, 1))[0] = _rtB->MultiportSwitch_m[0];
    ((real_T *)ssGetOutputPortSignal(S, 1))[1] = _rtB->MultiportSwitch_m[1];
    ((real_T *)ssGetOutputPortSignal(S, 1))[2] = _rtB->MultiportSwitch_m[2];
    ((real_T *)ssGetOutputPortSignal(S, 1))[3] = _rtB->MultiportSwitch_m[3];
    ((real_T *)ssGetOutputPortSignal(S, 1))[4] = _rtB->MultiportSwitch1_k[0];
    ((real_T *)ssGetOutputPortSignal(S, 1))[5] = _rtB->MultiportSwitch1_k[1];
    ((real_T *)ssGetOutputPortSignal(S, 1))[6] = _rtB->MultiportSwitch1_k[2];
    ((real_T *)ssGetOutputPortSignal(S, 1))[7] = _rtB->MultiportSwitch1_k[3];
  }
  ...
  if (ssIsSampleHit(S, 1, tid)) {
    ...
    _rtB->IntegralGain_o = 9.0 * _rtB->Sum_iz;
  }
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
  ...
  if (ssIsSampleHit(S, 1, tid)) {
    ...
    ((real_T *)ssGetDWork(S, 2))[0] = 5.0E-6 * _rtB->IntegralGain_p +
      _rtB->Integrator_g;

    /* Update for DiscreteIntegrator: '<S92>/Integrator' */
    ((real_T *)ssGetDWork(S, 3))[0] = 1.0E-5 * _rtB->IntegralGain_o + ((real_T *)
      ssGetDWork(S, 3))[0];
  }
...
static void mdlInitializeSizes(SimStruct *S)
{
...

  {
    ...
    ssRegisterMsgForNotSupportingMultiExecInst(S,
      "<diag_root><diag id=\"Simulink:blocks:BlockDoesNotSupportMultiExecInstances\"><arguments><arg type=\"encoded\"></arg><arg type=\"encoded\">PABfAF8AaQBpAFMAUwBfAF8APgA8AC8AXwBfAGkAaQBTAFMAXwBfAD4AAAA=</arg><arg type=\"encoded\">PABfAF8AaQB0AGUAcgBCAGwAawBfAF8APgA8AC8AXwBfAGkAdABlAHIAQgBsAGsAXwBfAD4AAAA=</arg></arguments></diag>\n</diag_root>");
...
# define S_FUNCTION_NAME               DCU2_sf
# include "cg_sfun.h"
