...
#include "InverterTuN_sf_private.h"
#include "simstruc.h"
#include "fixedpoint.h"
#if defined(RT_MALLOC) || defined(MATLAB_MEX_FILE)

extern void *InverterTuN_malloc(SimStruct *S);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  uint32_T intVal;
  uint32_T u;
  B_InverterTuN_T *_rtB;
  _rtB = ((B_InverterTuN_T *) ssGetLocalBlockIO(S));
