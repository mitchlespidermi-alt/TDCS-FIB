 ...
 */
#ifndef RTW_HEADER_InverterTuN_sf_h_
#define RTW_HEADER_InverterTuN_sf_h_
#include <string.h>
#include <stddef.h>
#ifndef InverterTuN_sf_COMMON_INCLUDES_
# define InverterTuN_sf_COMMON_INCLUDES_
#include <stdlib.h>
#define S_FUNCTION_NAME                InverterTuN_sf
...
#endif
#endif                                 /* InverterTuN_sf_COMMON_INCLUDES_ */

#include "InverterTuN_sf_types.h"
 ...
 *
 * hilite_system('CRH2forBenchmark_Copy/InverterN/InverterTuN')    - opens subsystem CRH2forBenchmark_Copy/InverterN/InverterTuN
 * hilite_system('CRH2forBenchmark_Copy/InverterN/InverterTuN/Kp') - opens and selects block Kp
 *
 * Here is the system hierarchy for this model
 *
 * '<Root>' : 'CRH2forBenchmark_Copy/InverterN'
 * '<S1>'   : 'CRH2forBenchmark_Copy/InverterN/InverterTuN'
 * '<S2>'   : 'CRH2forBenchmark_Copy/InverterN/InverterTuN/SU'
 */
#endif                                 /* RTW_HEADER_InverterTuN_sf_h_ */
