...
extern void *MeasurementN_malloc(SimStruct *S);
...
{
  X_MeasurementN_T *_rtX;
  _rtX = ((X_MeasurementN_T *) ssGetContStates(S));
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  real_T A;
  real_T B;
  B_MeasurementN_T *_rtB;
  X_MeasurementN_T *_rtX;
  _rtX = ((X_MeasurementN_T *) ssGetContStates(S));
  _rtB = ((B_MeasurementN_T *) ssGetLocalBlockIO(S));
...
{
  B_MeasurementN_T *_rtB;
  XDot_MeasurementN_T *_rtXdot;
  _rtXdot = ((XDot_MeasurementN_T *) ssGetdX(S));
  _rtB = ((B_MeasurementN_T *) ssGetLocalBlockIO(S));
