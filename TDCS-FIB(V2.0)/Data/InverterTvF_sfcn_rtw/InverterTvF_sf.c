...
#include "InverterTvF_sf_private.h"
#include "simstruc.h"
#include "fixedpoint.h"
#if defined(RT_MALLOC) || defined(MATLAB_MEX_FILE)

extern void *InverterTvF_malloc(SimStruct *S);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  uint32_T intVal;
  uint32_T u;
  B_InverterTvF_T *_rtB;
  _rtB = ((B_InverterTvF_T *) ssGetLocalBlockIO(S));
