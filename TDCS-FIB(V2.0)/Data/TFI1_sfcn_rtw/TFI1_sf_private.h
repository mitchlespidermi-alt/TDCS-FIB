 ...
 */
#ifndef RTW_HEADER_TFI1_sf_private_h_
#define RTW_HEADER_TFI1_sf_private_h_
#include "rtwtypes.h"
 ...
 *
 */
#if !defined(RTW_GENERATED_SFCN_TUNABLE_PRMS_TFI1_sf)
...
#define InvertBit(S)                   _ssGetSFcnParam(S,4)
#define NoiseSelec(S)                  _ssGetSFcnParam(S,5)
#define TH(S)                          _ssGetSFcnParam(S,6)
#endif                                 /* RTW_GENERATED_SFCN_TUNABLE_PRMS_TFI1_sf */
#endif                                 /* RTW_HEADER_TFI1_sf_private_h_ */
