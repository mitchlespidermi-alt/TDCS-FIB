...
MODEL              = Subsystem1
MODULES            = Subsystem1_sf_data.c rtGetInf.c rtGetNaN.c 
...
MEM_ALLOC          = RT_STATIC
MEXEXT             = mexw64
BUILDARGS          =  MODELLIB=Subsystem1lib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE
CREATEMODEL        = 1
USERMODULES        =  
USEPARAMVALUES     = 0
MEX_OPT_FILE       = -f "C:\Users\CSU-CRH\AppData\Roaming\MathWorks\MATLAB\R2014a\mex_C_win64.xml"
COMPUTER           = PCWIN64
VISUAL_VER         = 7.1SDK
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\Subsystem1_sfcn_rtw
