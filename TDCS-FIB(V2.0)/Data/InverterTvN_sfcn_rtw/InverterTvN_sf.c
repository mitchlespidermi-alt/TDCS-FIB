 ...
 */
#include <math.h>
#include "InverterTvN_sf.h"
#include "InverterTvN_sf_private.h"
#include "simstruc.h"
#include "fixedpoint.h"
#if defined(RT_MALLOC) || defined(MATLAB_MEX_FILE)

extern void *InverterTvN_malloc(SimStruct *S);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  uint32_T intVal;
  uint32_T u;
  B_InverterTvN_T *_rtB;
  _rtB = ((B_InverterTvN_T *) ssGetLocalBlockIO(S));
