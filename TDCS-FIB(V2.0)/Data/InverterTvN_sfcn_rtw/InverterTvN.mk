...
MAKEFILE           = InverterTvN.mk
MATLAB_ROOT        = D:\SOFTWARE\MATLAB\R2014a
ALT_MATLAB_ROOT    = D:\SOFTWARE\MATLAB\R2014a
MATLAB_BIN         = D:\SOFTWARE\MATLAB\R2014a\bin
ALT_MATLAB_BIN     = D:\SOFTWARE\MATLAB\R2014a\bin
MASTER_ANCHOR_DIR  = 
START_DIR          = D:\DOC\code\Benchmark\TDCS-FIB(V2.0)201707214alllock\Data
S_FUNCTIONS        = 
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 1
...
MEM_ALLOC          = RT_STATIC
MEXEXT             = mexw64
BUILDARGS          =  MODELLIB=InverterTvNlib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE
CREATEMODEL        = 1
USERMODULES        =  
USEPARAMVALUES     = 0
MEX_OPT_FILE       = -f "D:\SOFTWARE\MATLAB\R2014a\bin\win64\mexopts\winsdk-7.1_c.xml"
COMPUTER           = PCWIN64
VISUAL_VER         = 7.1SDK
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\InverterTvN_sfcn_rtw
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\comm\extern\comm_rt\export\include
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(MATLAB_ROOT)\toolbox\comm\extern\comm_rt\export\include\comm_rt
...
{$(MATLAB_ROOT)\toolbox\comm\extern\comm_rt}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(MEX_FLAGS) $<

{$(MATLAB_ROOT)\toolbox\comm\extern\comm_rt\export\include}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(MEX_FLAGS) $<

{$(MATLAB_ROOT)\toolbox\comm\extern\comm_rt\export\include\comm_rt}.c.obj :
	@cmd /C "echo ### Compiling $<"
	$(CC) $(MEX_FLAGS) $<
...
{$(MATLAB_ROOT)\toolbox\comm\extern\comm_rt}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CPP) $(MEX_FLAGS) $<

{$(MATLAB_ROOT)\toolbox\comm\extern\comm_rt\export\include}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CPP) $(MEX_FLAGS) $<

{$(MATLAB_ROOT)\toolbox\comm\extern\comm_rt\export\include\comm_rt}.cpp.obj :
	@cmd /C "echo ### Compiling $<"
	$(CPP) $(MEX_FLAGS) $<
