...
MODEL              = CFI10
MODULES            = CFI10_sf_data.c rtGetInf.c rtGetNaN.c 
MAKEFILE           = CFI10.mk
MATLAB_ROOT        = d:\Program Files\MATLAB\R2013a
ALT_MATLAB_ROOT    = d:\PROGRA~2\MATLAB\R2013a
MATLAB_BIN         = d:\Program Files\MATLAB\R2013a\bin
ALT_MATLAB_BIN     = d:\PROGRA~2\MATLAB\R2013a\bin
MASTER_ANCHOR_DIR  = 
START_DIR          = C:\Users\R\Desktop\TDCS-FIB(V1.1)\TDCS-FIB(V1.1)\Data
S_FUNCTIONS        = 
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 2
...
MEM_ALLOC          = RT_STATIC
MEXEXT             = mexw64
BUILDARGS          =  MODELLIB=CFI10lib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE
CREATEMODEL        = 1
USERMODULES        =  
USEPARAMVALUES     = 0
MEX_OPT_FILE       = -f C:\Users\R\AppData\Roaming\MATHWO~1\MATLAB\R2013a\mexopts.bat
COMPUTER           = PCWIN64
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\CFI10_sfcn_rtw
