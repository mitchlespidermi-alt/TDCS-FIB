...
MODEL              = DCU1
MODULES            = DCU1_sf_data.c rtGetInf.c rtGetNaN.c 
MAKEFILE           = DCU1.mk
...
MEM_ALLOC          = RT_STATIC
MEXEXT             = mexw64
BUILDARGS          =  MODELLIB=DCU1lib.lib RELATIVE_PATH_TO_ANCHOR=.. MODELREF_TARGET_TYPE=NONE
CREATEMODEL        = 1
USERMODULES        =  
USEPARAMVALUES     = 0
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\DCU1_sfcn_rtw
