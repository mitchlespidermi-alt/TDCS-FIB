...
#include <math.h>
#include "SABF_sf.h"
#include "SABF_sf_private.h"
#include "simstruc.h"
#include "fixedpoint.h"
#if defined(RT_MALLOC) || defined(MATLAB_MEX_FILE)

extern void *SABF_malloc(SimStruct *S);
...
{
  B_SABF_T *_rtB;
  _rtB = ((B_SABF_T *) ssGetLocalBlockIO(S));

  /* MATLAB Function: '<Root>/SABF' incorporates:
   *  Inport: '<Root>/SA'
   *  Inport: '<Root>/SB'
   */
  /* MATLAB Function 'SABF': '<S1>:1' */
  /* '<S1>:1:3' */
  _rtB->P = 0.0;
  ...
  /* End of MATLAB Function: '<Root>/SABF' */
